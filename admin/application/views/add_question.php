                                        ...
                                        <div class="card-body">                   
                                            <form action="<?php echo base_url("Add_question/InsertQuestion") ?>" id="form_data" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                ...
                                                <div class = "form-group row">
                                                    ...
                                                    <div class = "col-sm-10">
                                                        <input class = "form-control" type = "text" placeholder = "Question" name = "question" id = "question" value="<?php echo (isset($edit_question) ? htmlentities($edit_question[0]['question']) : ''); ?>" required = "">
                                                        <div class="col-sm-9">
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($all_data as $val) {
                                                        ...
                                                        echo "<td> <img src=Images/question/" . $val->image . "  id='image-link' alt='image' class='img-responsive' height=50 width=50></td>";
