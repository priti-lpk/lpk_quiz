                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Create States</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="<?php echo base_url("Add_state/InsertState") ?>" id="form_data" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control select2" name="country_id" id="country_id" required="">
                                                            ...
                                                            foreach ($country as $val) {
                                                                echo "<option " . ($val->id == $edit_state[0]['country_id'] ? 'selected' : '') . " value='" . $val->id . "'>" . $val->cname . "</option> ";
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text"  placeholder="State Name" id="state_name" name="state_name" value="<?= (isset($edit_state)) ? $edit_state[0]['state_name'] : '' ?>" required="">
                                                    </div>
                                                </div>

                                                <div class="button-items">
                                                    <input type="hidden" name="action" id="action" value="<?php echo (isset($edit_state) ? 'edit' : 'add') ?>"/>
                                                    <?= (isset($edit_state)) ? '<input type="hidden" name="id" value="' . $this->uri->segment(3) . '">' : '' ?>
                                                    <button type="submit" id="btn_save" class="btn btn-primary waves-effect waves-light"><?php echo (isset($edit_state) ? 'Edit' : 'Save') ?></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Main State List</h4><br>
...
//                                                  
                                                        echo "<td><a href='" . base_url('add_state/update_data/' . $val->id . '') . "' class='btn btn-primary waves-effect waves-light'>Edit</a> <a href='" . base_url('add_state/delete_data/' . $val->id . '') . "' class='btn btn-danger btn_delete' id='" . $val->id . "'>Delete</a></td>";
