...
<html lang="en">
    ...
    <head>
        ...
        <title>View_Yearly_Leaderboard_Report</title>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">View_Yearly_Leaderboard_Report</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">View_Yearly_Leaderboard_Report</h4>
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $k = 1;
                                                    foreach ($Yearly_Leaderboard as $val) {
                                                        echo "<tr>";
                                                        echo "<td>" . $k++ . "</td>";
