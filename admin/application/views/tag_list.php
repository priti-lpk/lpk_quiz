                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="<?php echo base_url("Add_tag/InsertTag") ?>" id="form_data" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                <h4 class="mt-0 header-title">Textual inputs</h4>
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Tag Name</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text"  placeholder="Tag Name" id="tag_name" name="tag_name" value="<?php echo (isset($edit_tag) ? $edit_tag[0]['tag_name'] : ''); ?>" required="">
                                                    </div>
                                                </div>

                                                <div class="button-items">
                                                    <input type="hidden" name="action" id="action" value="<?php echo (isset($edit_tag) ? 'edit' : 'add') ?>"/>
                                                    <?= (isset($edit_tag)) ? '<input type="hidden" name="id" value="' . $this->uri->segment(3) . '">' : '' ?>
                                                    <button type="submit" id="btn_save" class="btn btn-primary waves-effect waves-light"><?php echo (isset($edit_tag) ? 'Edit' : 'Save') ?></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Tag List</h4><br>
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($tag as $val) {
                                                        echo "<tr>";
                                                        echo "<td>" . $k . "</td>";
                                                        echo "<td>" . $val->tag_name . "</td>";

                                                        echo "<td><a href='" . base_url('add_tag/update_data/' . $val->id . '') . "' class='btn btn-primary waves-effect waves-light'>Edit</a> <a href='" . base_url('add_tag/delete_data/' . $val->id . '') . "' class='btn btn-danger btn_delete' id='" . $val->id . "'>Delete</a></td>";
